...
describe(`getFrameAtTime`, () => {
  describe(`An animation with multiple frames`, () => {
    ...
    it(`Correctly interpolates frame properties between two frames`, () => {
      ...
      // The ending frame has no duration (last frame)
      ...
      const interpolatedTime: number = frame1.duration - frame1.duration * interpolationRatio
